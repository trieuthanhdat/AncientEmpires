	...
	internal void _0024advancedExamples_0024closure_002410()
	{
		for (int i = 0; i < 10; i++)
		{
			...
			LeanTween.moveZ(gameObject2, 0f, 0.3f).setDelay(1.2f + (float)i * 0.4f).setEase(LeanTweenType.easeSpring)
				.setOnComplete(()=> _0024_0024advancedExamples_0024closure_002410_0024closure_002411(gameObject2))
			...
			LeanTween.alpha(gameObject2, 0f, 0.6f).setDelay(9.2f + (float)i * 0.4f).setDestroyOnComplete(doesDestroy: true)
				.setOnComplete(()=> _0024_0024advancedExamples_0024closure_002410_0024closure_002412(gameObject2))
				.setOnCompleteParam(gameObject);
		}
	}
